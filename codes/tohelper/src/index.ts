  ...
  ctx.webServer.register({
    ...
    async handler(req: IncomingMessage, res: ServerResponse) {
      try {
        ...
        await connectMcpServer(serverName, normalizeTransport(transport), { command, args, url, headers })
      ...
      try {
        ...
        for (const [serverName, entry] of Object.entries(mcpServers)) {
          ...
          try {
            ...
            await connectMcpServer(serverName, transport, {
