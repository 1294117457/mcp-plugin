...
在 schema 中表达自身完备的约束，使无效配置在插件加载时失败。对服务或已注册资源的引用需要依赖注入；[服务教程](https://deepseek-harness.github.io/deepseek-harness/develop/framework/service) 会介绍这项约定。
...
- [打包与安装插件](https://deepseek-harness.github.io/deepseek-harness/develop/basic/publish) — 把插件以可安装包的形式交付
- [插件与生命周期](https://deepseek-harness.github.io/deepseek-harness/develop/framework/) — 深入了解插件的完整生命周期
- [服务与依赖](https://deepseek-harness.github.io/deepseek-harness/develop/framework/service) — 让你的插件对外提供服务