...
大多数情况下，函数形式足够了。当插件需要向其他插件提供服务时，可使用类形式（见 [服务与依赖](https://deepseek-harness.github.io/deepseek-harness/develop/framework/service)）。

## 下一步 

- [开发一个工具](https://deepseek-harness.github.io/deepseek-harness/develop/basic/tool) — 了解工具定义 DSL
- [插件配置](https://deepseek-harness.github.io/deepseek-harness/develop/basic/config) — 让插件接受用户配置
- [Cordis 框架教程](https://deepseek-harness.github.io/deepseek-harness/develop/cordis-tutorial/) — 底层的插件框架，在临时目录中动手构建，无需 API 密钥
